/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: abc5950bef12360514c8de449262bc9f)
...
interface __BaseEnv_Env {
	...
	HA_MCP_URL: string;
	HA_TOKEN: string;
	PersonalAgent: DurableObjectNamespace<import("./src/index").PersonalAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PersonalAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEGRAM_BOT_TOKEN" | "TELEGRAM_BOT_USERNAME" | "TELEGRAM_WEBHOOK_SECRET_TOKEN" | "TAVILY_API_KEY" | "HA_MCP_URL" | "HA_TOKEN">> {}
}
