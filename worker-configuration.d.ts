/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7db738ad90cedcf2924cf2c7be543a5f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			Cloudflare.Env,
			'TELEGRAM_BOT_TOKEN' | 'TELEGRAM_BOT_USERNAME' | 'TELEGRAM_WEBHOOK_SECRET_TOKEN' | 'TAVILY_API_KEY' | 'GITHUB_TOKEN'
		>
	> {}
}
